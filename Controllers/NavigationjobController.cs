...
namespace DienappApi.Controllers
{
    ...
    public class NavigationjobController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateNavigationjobById(int id,
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Navigationjob>> CreateNavigationjob(Navigationjob
                            navigationjob)
        {
            ...
            return CreatedAtAction("GetNavigationjob", new { id = navigationjob.NavigationjobId },
                            navigationjob);
        }
